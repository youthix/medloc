    			...
    			ListIterator<StockistDetail> lsItrStockist = responseDataObj.getListStockistDetail().getStockistDetail().listIterator();
    			  ...
    			  while(lsItrStockist.hasNext()){
    				  ...
    				  stockistDetailobj = lsItrStockist.next();
    					  ...
    					  detailobj.setShortAdd(stockistDetailobj.getShortAdd());
    					  detailobj.setMrp(stockistDetailobj.getMrp());
    					  detailobj.setdPrice(stockistDetailobj.getdPrice());
    					  detailobj.setDiscPer(stockistDetailobj.getDiscPer());
